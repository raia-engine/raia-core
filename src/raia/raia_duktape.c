...
static duk_ret_t regist_raia_lib_add(duk_context *ctx) {
...
static void regist_functions(duk_context *ctx) {
    ...
    regist_func(ctx, regist_raia_lib_add, "_raia_lib_add", 3);
}
...
static void regist_objects(duk_context *ctx) {
    char *objects =
            "var Raia = {"
            "    C: {"
            "        puts: function(a){_raia_c_puts(a);},"
            "    },"
            "    Lib: {"
            ...
            "        add: function(a,b,c){_raia_lib_add(a,b,c);},"
            "    },"
            "};";
